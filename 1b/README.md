...
| :--- | :--- | :--- | :--- |
| **Random Subsampling** | $O(N)$ | 0.003 | Экстремально высокая |
| **Voxel Grid** | $O(N)$ | 0.161 | Высокая |
| **FPS (Farthest Point)** | $O(N \cdot k)$ | 113.872 | Низкая |
...
## Технический стек
* **Language**: Python 3.x
* **Libraries**: NumPy (Data processing), Matplotlib (Visualization)
* **Data format**: ASCII (.asc / .xyz)
